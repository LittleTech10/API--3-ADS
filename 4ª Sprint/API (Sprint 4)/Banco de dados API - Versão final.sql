...
create table Acoes (
	...
	tipo_acao desc100 check(tipo_acao in('Troca de senha','Troca de nome', 'Troca de usuário', 'Troca de nome e usuário', 'Troca de email', 'Troca de nome e email', 'Troca de usuário e email', 'Troca de nome, usuário e email')) not null,
